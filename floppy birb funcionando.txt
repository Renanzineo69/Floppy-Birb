...
def atualizar_birb_img(personagem_img):
    personagem_img = pygame.transform.scale(personagem_img, (personagem_img.get_width() * 0.66, personagem_img.get_height() * 0.66))
    global birb_img
...
def mostra_tela_inicio(background_x = 0):
    ...
    # Lista com as letras do título e suas posições na tela
    letras = [
    ...
    while True:
        ...
        # Renderiza o texto "Pressione ESPAÇO para começar" na parte inferior da tela
        texto_inicio = fonte.render("Pressione ESPAÇO para começar", True, PRETO)
